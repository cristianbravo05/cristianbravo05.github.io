...
@Component({
  selector: 'app-english-class-verb',
  templateUrl: './english-class-verb.component.html',
  styleUrls: ['./english-class-verb.component.css'],
})
export class EnglishClassVerbComponent implements OnInit {
  ...
  public MemoriGame: MemoriGameVerb[]
  ...
  ngOnInit(): void {
    ...
    this.actRoute.params.subscribe(params => {
     ...
     if(this.list === "100"){
      ...
      this.url = `/assets/${this.list}-VerbsMoreUsed.json`
      ...
      [
        {
         ...
         },
         {
          verbo: "accomplish",
          pasado: "accomplished",
          participio: "accomplished",
          espanol: "lograr"
         },
         {
          verbo: "account",
          pasado: "accounted",
          participio: "accounted",
          espanol: "considerar"
         },
         {
          verbo: "accuse",
    ...
    try {
      ...
      const RandonWordPast: HTMLElement = document.getElementById('RandonWordPast') as HTMLElement
      const RandonWordPart: HTMLElement = document.getElementById('RandonWordPart') as HTMLElement
      ...
      RandonWord.innerHTML = this.MemoriGame[this.word].verbo!
      RandonWordPast.innerHTML = this.MemoriGame[this.word].pasado!
      RandonWordPart.innerHTML = this.MemoriGame[this.word].participio!
  ...
  getRandomIntBox(max:any,min:any) {
    ...
    if(!this.wordnumber.includes(this.wordbox2)){
          ...
          this.wordstring.push(this.MemoriGame[this.wordbox2].verbo!)
    ...
    if(!this.wordstring.includes(this.MemoriGame[this.word].verbo!)){
  ...
  ChangeWord(type:number){

    var listenword

    const RandonWord = document?.getElementById("RandonWord")?.textContent;
    const RandonWordPast = document?.getElementById("RandonWordPast")?.textContent;
    const RandonWordPart = document?.getElementById("RandonWordPart")?.textContent;

    if(type == 1){

      listenword = RandonWord

    }else if(type == 2){

      listenword = RandonWordPast

    }else if(type == 3){

      listenword = RandonWordPart
    ...
    if(listenword){
      ...
      var RandonWord2 = new SpeechSynthesisUtterance(listenword)
      ...
      let fileReader = new FileReader();
        fileReader.onload = (e) => {
            ...
            for(const key in this.MemoriGame){
              ...
              delete this.MemoriGame[key].verbo
